...
class SellBot {
  constructor() {
    ...
    // 매도 패턴들
    this.patterns = [
      { name: "점진적매도", weight: 12, volatility: "낮음", speed: "보통" },
      { name: "급락매도", weight: 8, volatility: "매우높음", speed: "빠름" },
      { name: "저항선매도", weight: 10, volatility: "보통", speed: "보통" },
      { name: "익절매도", weight: 15, volatility: "보통", speed: "빠름" },
      { name: "모멘텀매도", weight: 12, volatility: "높음", speed: "매우빠름" },
      { name: "스캘핑매도", weight: 20, volatility: "낮음", speed: "매우빠름" },
      { name: "하락돌파매도", weight: 6, volatility: "매우높음", speed: "빠름" },
      { name: "물량분산", weight: 8, volatility: "낮음", speed: "느림" },
      { name: "패닉매도", weight: 3, volatility: "극높음", speed: "매우빠름" },
      { name: "안정매도", weight: 10, volatility: "낮음", speed: "보통" },
      { name: "대량매도", weight: 4, volatility: "높음", speed: "보통" },
      { name: "갭메우기매도", weight: 12, volatility: "보통", speed: "빠름" },
    ]
  ...
  async placeOrder(price, quantity, orderType, isBalancing = false) {
    try {
      ...
      if (!isBalancing) {
        ...
        console.log(
          `🔴 [매도] ${this.currentPattern.name} | ${price.toLocaleString()}원 ${quantity}주 ${orderType} | ${currentTime}`,
        )
      ...
      console.error(`🔴 [매도실패] ${error.response?.data?.message || error.message}`)
    }
  }
